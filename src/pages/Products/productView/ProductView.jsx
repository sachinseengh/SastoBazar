...
const ProductView = ({products,isloading}) => {
    ...
    if(isloading){
        ...
        <div role="status">
            <svg aria-hidden="true" className="inline w-96 h-96 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='mb-4 bg-[#FFFFFF] border flex justify-center items-center'>
                <div className='relative max-w-md mx-auto overflow-hidden'>
                    ...
                    className='w-full h-auto rounded object-cover cursor-pointer transition-transform
                    duration-300 hover:scale-105'/>

                    <div className='absolute inset-0 hidden md:flex justify-center items-center
                    bg-black bg-opacity-10 rounded-md cursor-zoom-in'>
            ...
            <div className='px-4'>
                <div>
                    <h2 className='text-2xl font-bold text-gray-700 mb-2'>{singleProduct.title}</h2>
                    <div className='mb-4'>
                    ...
                    <div className='flex items-center mt-3 mb-4 text-gray-700'>
                    ...
                    <div className='mb-4'>
                        <span className='text-base text-gray-700 '>{singleProduct.description}</span>
                        <hr  className='border-b border-dotted w-3/5 border-gray-400 mt-2'/>
                    </div>
                    <div className='mb-4 flex space-x-2'>
                        <button className='bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4
                        rounded w-64'>
                            Add to cart
                        </button>
