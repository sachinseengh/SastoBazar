...
const commonpages = (props) => {
  return (
   ...
   <div className='  container font-poppins px-4 py-16 mix-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl
    ...
    '>
        <div className='grid gap-8 lg:grid-cols-2'>
            ...
            <div className='flex justify-center'>
                <img src={props.image} alt="sastoBazar" className='w-full h-full max-w-md object-contain animate-moveUpDown' />
            </div>
        </div>
    </div>
   </>
